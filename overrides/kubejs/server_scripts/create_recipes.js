ServerEvents.recipes(e => {
    ...
    e.shaped('create:mechanical_arm', [
        ...
        "L  ",
        "IC "
    ], { A: "create:andesite_alloy", C: "create:brass_casing", I: "create:precision_mechanism", L: "#forge:plates/brass" }).stage('crafter');
    e.shaped('create:deployer', [
        "B",
        "C",
        "I"
    ], { B: "create:electron_tube", C: "create:andesite_casing", I: "create:brass_hand" }).stage('crafter');
    //flywheel
    ...
    e.recipes.create.mechanical_crafting('createaddition:tesla_coil', [
        ...
        "CBC",
        "PEP"
    ], { A: "create:andesite_alloy", C: "createaddition:capacitor", P: "#forge:plates/brass", B: "create:brass_casing" }).stage('basicelcity');
