...
//以下是mek配方分区
  ...
  e.custom({
    "type": "mekanism:infusion_conversion",
    "input": { "ingredient": { "tag": "forge:ingots/constantan" } },
    "output": { "amount": 20, "infuse_type": "kubejs:constantan" }
  }).stage("bsamt");

  e.custom({
    "type": "mekanism:infusion_conversion",
    "input": { "ingredient": { "tag": "forge:nuggets/constantan" } },
    "output": { "amount": 2, "infuse_type": "kubejs:constantan" }
  }).stage("bsamt");

  e.custom({
    "type": "mekanism:infusion_conversion",
    "input": { "ingredient": { "tag": "forge:plates/constantan" } },
    "output": { "amount": 10, "infuse_type": "kubejs:constantan" }
  }).stage("bsamt");

  e.custom({
    "type": "mekanism:infusion_conversion",
    "input": { "ingredient": { "tag": "forge:dusts/constantan" } },
    "output": { "amount": 20, "infuse_type": "kubejs:constantan" }
  }).stage("bsamt");
  ...
  e.custom({
    "type": "mekanism:metallurgic_infusing",
    "chemicalInput": { "amount": 20, "infuse_type": "kubejs:constantan" },
  ...
  e.custom({
    "type": "mekanism:metallurgic_infusing",
    "chemicalInput": { "amount": 20, "infuse_type": "kubejs:scarlet_neodymium" },
  ...
  e.custom({
    "type": "mekanism:metallurgic_infusing",
    "chemicalInput": { "amount": 20, "infuse_type": "kubejs:nickel" },
    "itemInput": { "ingredient": { "tag": "forge:ingots/copper" } },
    "output": { "item": "immersiveengineering:ingot_constantan", "count": 1 }
  }).stage("bsamt");

  e.custom({
    "type": "mekanism:metallurgic_infusing",
    "chemicalInput": { "amount": 20, "infuse_type": "kubejs:azure_neodymium" },
    "itemInput": { "ingredient": { "tag": "forge:ingots/black_steel" } },
  ...
  e.custom({
    ...
    "output": { "item": "immersiveengineering:wirecoil_redstone", "count": 2 }
  }).stage("bsamt");
...
e.custom({
  ...
  e.custom({
  "type":"mekanism:enriching",
  "input":{"amount":3,"ingredient": { "item": 'fallout:raw_mithril'}},
  "output":{"count":4,'item':"fallout:mithril_ingot"}
  }).stage("bsamt");

    e.custom({
  "type":"mekanism:enriching",
  "input":{"amount":3,"ingredient": { "item": "fallout:raw_orichalcum"}},
  "output":{"count":4,'item':"fallout:orichalcum_ingot"}
  }).stage("bsamt");
  ...
  e.custom({
    ...
    "itemInput":{"amount":3,"ingredient":{"item":"fallout:raw_mithril"}},
    "output":{"amount":2000,"chemicalType":"slurry","slurry":"kubejs:dirty_mithril"}
  }).stage("teamt");
  e.custom({
    "type":"mekanism:dissolution",
    "gasInput":{"amount":1,"gas":"mekanism:sulfuric_acid"},
    "itemInput":{"amount":1,"ingredient":{"item":"fallout:deepslate_mithril_ore"}},
    "output":{"amount":1000,"chemicalType":"slurry","slurry":"kubejs:dirty_mithril"}
  }).stage("teamt");
  e.custom({
    "type":"mekanism:dissolution",
    "gasInput":{"amount":1,"gas":"mekanism:sulfuric_acid"},
    "itemInput":{"amount":3,"ingredient":{"item":"fallout:raw_orichalcum"}},
    "output":{"amount":2000,"chemicalType":"slurry","slurry":"kubejs:dirty_orichalcum"}
  }).stage("teamt");
  e.custom({
    "type":"mekanism:dissolution",
    "gasInput":{"amount":1,"gas":"mekanism:sulfuric_acid"},
    "itemInput":{"amount":1,"ingredient":{"item":"fallout:deepslate_orichalcum_ore"}},
    "output":{"amount":1000,"chemicalType":"slurry","slurry":"kubejs:dirty_orichalcum"}
  }).stage("teamt");
  //清洗
  e.recipes.mekanism.washing(
    Fluid.of("minecraft:water",5),
    {slurry:"kubejs:dirty_mithril",amount:1},
    {slurry:"kubejs:clean_mithril",amount:1}
  ).stage("teamt");
  e.recipes.mekanism.washing(
    Fluid.of("minecraft:water",5),
    {slurry:"kubejs:dirty_orichalcum",amount:1},
    {slurry:"kubejs:clean_orichalcum",amount:1}
  ).stage("teamt");
  //结晶
  e.custom({
    "type":"mekanism:crystallizing",
    "chemicalType":"slurry",
    "input":{"amount":200,"slurry":"kubejs:clean_orichalcum"},
    "output":{"item":"fallout:crystal_orichalcum"}
  }).stage("teamt");
  e.custom({
    "type":"mekanism:crystallizing",
    "chemicalType":"slurry",
    "input":{"amount":200,"slurry":"kubejs:clean_mithril"},
    "output":{"item":"fallout:crystal_mithril"}
  }).stage("teamt");
  //压射
  e.custom({
    "type":"mekanism:injecting",
    "chemicalInput":{"amount":1,"gas":"mekanism:hydrogen_chloride"},
    "itemInput":{"ingredient":{"item":"fallout:crystal_mithril"}},
    "output":{"item":"fallout:shard_mithril"}
  }).stage("elamt");
  e.custom({
    "type":"mekanism:injecting",
    "chemicalInput":{"amount":1,"gas":"mekanism:hydrogen_chloride"},
    "itemInput":{"ingredient":{"item":"fallout:deepslate_mithril_ore"}},
    "output":{"count":4,"item":"fallout:shard_mithril"}
  }).stage("elamt");
  e.custom({
    "type":"mekanism:injecting",
    "chemicalInput":{"amount":1,"gas":"mekanism:hydrogen_chloride"},
    "itemInput":{"amount":3,"ingredient":{"item":"fallout:raw_mithril"}},
    "output":{"count":8,"item":"fallout:shard_mithril"}
  }).stage("elamt");
  e.custom({
    "type":"mekanism:injecting",
    "chemicalInput":{"amount":1,"gas":"mekanism:hydrogen_chloride"},
    "itemInput":{"ingredient":{"item":"fallout:crystal_orichalcum"}},
    "output":{"item":"fallout:shard_orichalcum"}
  }).stage("elamt");
  e.custom({
    "type":"mekanism:injecting",
    "chemicalInput":{"amount":1,"gas":"mekanism:hydrogen_chloride"},
    "itemInput":{"ingredient":{"item":"fallout:deepslate_orichalcum_ore"}},
    "output":{"count":4,"item":"fallout:shard_orichalcum"}
  }).stage("elamt");
  e.custom({
    "type":"mekanism:injecting",
    "chemicalInput":{"amount":1,"gas":"mekanism:hydrogen_chloride"},
    "itemInput":{"amount":3,"ingredient":{"item":"fallout:raw_orichalcum"}},
    "output":{"count":8,"item":"fallout:shard_orichalcum"}
  }).stage("elamt");
  //提纯
  e.custom({
    ...
    "itemInput":{"ingredient":{"item":"fallout:deepslate_mithril_ore"}},
    "output":{"count":3,"item":"fallout:clump_mithril"}
  }).stage("elamt");
  e.custom({
    "type":"mekanism:purifying",
    "chemicalInput":{"amount":1,"gas":"mekanism:oxygen"},
    "itemInput":{"ingredient":{"item":"fallout:raw_mithril"}},
    "output":{"count":2,"item":"fallout:clump_mithril"}
  }).stage("elamt");
  e.custom({
    "type":"mekanism:purifying",
    "chemicalInput":{"amount":1,"gas":"mekanism:oxygen"},
    "itemInput":{"ingredient":{"item":"fallout:shard_mithril"}},
    "output":{"item":"fallout:clump_mithril"}
  }).stage("elamt");
  e.custom({
    "type":"mekanism:purifying",
    "chemicalInput":{"amount":1,"gas":"mekanism:oxygen"},
    "itemInput":{"ingredient":{"item":"fallout:deepslate_orichalcum_ore"}},
    "output":{"count":3,"item":"fallout:clump_orichalcum"}
  }).stage("elamt");
  e.custom({
    "type":"mekanism:purifying",
    "chemicalInput":{"amount":1,"gas":"mekanism:oxygen"},
    "itemInput":{"ingredient":{"item":"fallout:raw_orichalcum"}},
    "output":{"count":2,"item":"fallout:clump_orichalcum"}
  }).stage("elamt");
  e.custom({
    "type":"mekanism:purifying",
    "chemicalInput":{"amount":1,"gas":"mekanism:oxygen"},
    "itemInput":{"ingredient":{"item":"fallout:shard_orichalcum"}},
    "output":{"item":"fallout:clump_orichalcum"}
  }).stage("elamt");
  //粉碎
  e.custom({
    "type":"mekanism:crushing",
    "input":{"ingredient":{"item":"fallout:clump_mithril"}},
    "output":{"item":"fallout:dirty_dust_mithril"}
  }).stage("bsamt");
  e.custom({
    "type":"mekanism:crushing",
    "input":{"ingredient":{"item":"fallout:clump_orichalcum"}},
    "output":{"item":"fallout:dirty_dust_orichalcum"}
  }).stage("bsamt");
  //富集
  e.custom({
    "type":"mekanism:enriching",
    "input":{"ingredient":{"item":"fallout:dirty_dust_mithril"}},
    "output":{"item":"fallout:dust_mithril"}
  }).stage("bsamt");
  e.custom({
    "type":"mekanism:crushing",
    "input":{"ingredient":{"item":"fallout:mithril_ingot"}},
    "output":{"item":"fallout:dust_mithril"}
  }).stage("bsamt");
  e.custom({
    "type":"mekanism:enriching",
    "input":{"ingredient":{"item":"fallout:deepslate_mithril_ore"}},
    "output":{"count":2,"item":"fallout:dust_mithril"}
  }).stage("bsamt");
  e.custom({
    "type":"mekanism:enriching",
    "input":{"amount":3,"ingredient":{"item":"fallout:raw_mithril"}},
    "output":{"count":4,"item":"fallout:dust_mithril"}
  }).stage("bsamt");
  e.custom({
    "type":"mekanism:enriching",
    "input":{"ingredient":{"item":"fallout:dirty_dust_orichalcum"}},
    "output":{"item":"fallout:dust_orichalcum"}
  }).stage("bsamt");
  e.custom({
    "type":"mekanism:crushing",
    "input":{"ingredient":{"item":"fallout:orichalcum_ingot"}},
    "output":{"item":"fallout:dust_orichalcum"}
  }).stage("bsamt");
  e.custom({
    "type":"mekanism:enriching",
    "input":{"ingredient":{"item":"fallout:deepslate_orichalcum_ore"}},
    "output":{"count":2,"item":"fallout:dust_orichalcum"}
  }).stage("bsamt");
  e.custom({
    "type":"mekanism:enriching",
    "input":{"amount":3,"ingredient":{"item":"fallout:raw_orichalcum"}},
    "output":{"count":4,"item":"fallout:dust_orichalcum"}
  }).stage("bsamt");
  //熔炼
  e.custom({
    ...
    "cookingtime":100,
    "experience":0.5,
    "ingredient":{"item":"fallout:dust_mithril"},
    "result":"fallout:mithril_ingot"
  }).stage("bsamt");
  e.custom({
  ...
  e.custom({
    ...
    "cookingtime":100,
    "experience":0.5,
    "ingredient":{"item":"fallout:dust_orichalcum"},
    "result":"fallout:orichalcum_ingot"
  }).stage("bsamt");
  e.custom({
    "type":"minecraft:smelting",
    "cookingtime":200,
...
e.custom({
  ...
  e.custom({
    "type": "mekanism:metallurgic_infusing",
    "chemicalInput": { "amount": 20, "infuse_type": "kubejs:blue_steel" },
...
"RRR"
  ...
  R:"#forge:nuggets/refined_obsidian",
  P:"mekanism:nugget_refined_obsidian"
}).stage("obsidian");
e.shaped("mekanism:block_refined_obsidian",[
"RRR",
"RPR",
"RRR"
],{
...
e.shaped("4x mekanismgenerators:turbine_valve",[
  " A ",
  "ACA",
  " A "
],{
