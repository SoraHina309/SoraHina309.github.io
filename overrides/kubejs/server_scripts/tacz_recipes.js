ServerEvents.recipes(e => {
  ...
  }).id('tacz:gun_brass_table').stage('steamgun');
  ...
  e.shapeless(Item.of('minecraft:gunpowder', 6), [
  ...
  e.custom({
    ...
    result: { "type": "ammo", "id": "tacz:40mm", "count": 6 }
  }).id('tacz:ammo/40mm');
  ...
  e.custom({
    ...
    materials: [
      ...
      { "item": { "tag": "forge:nuggets/steel" }, "count": 9 },
      { "item": { "tag": "forge:gunpowder" }, "count": 6 }
    ],
  ...
  e.custom({
    ...
    materials: [
      { "item": { "tag": "forge:plates/brass" }, "count": 24 },
      { "item": { "tag": "forge:ingots/steel" }, "count": 1 },
      { "item": { "tag": "forge:gunpowder" }, "count": 9 }
    ],
    result: { "type": "ammo", "id": "cyber_armorer:bullet_sniper", "count": 16 }
  ...
  e.custom({
    ...
    materials: [
      ...
      { "item": { "item": "mekanism:advanced_chemical_tank" }, "count": 1 },
      { "item": { "item": "mekanism:ingot_refined_obsidian" }, "count": 1 }
    ],
    result: { "type": "ammo", "id": "tacz:rpg_rocket", "count": 1 }
  ...
  // 添加 immersive_armorer:standard_rail_pistol_mk1 的配�?
  e.custom({
    type: "tacz:gun_smith_table_crafting",
    materials: [
      { "item": { "item": "fallout:steel_parts" }, "count": 15 },
      { "item": { "item": "immersiveengineering:toolupgrade_revolver_electro" }, "count": 1 },
      { "item": { "tag": "forge:treated_wood" }, "count": 4 }
    ],
    result: { "type": "gun", "id": "immersive_armorer:standard_rail_pistol_mk1" }
  }).id('immersive_armorer:gun/standard_rail_pistol_mk1');

  // 添加 immersive_armorer:standard_rail_pistol_mk2 的配�?
  e.custom({
    type: "tacz:gun_smith_table_crafting",
    materials: [
      { "item": { "type": "forge:partial_nbt", "item": "tacz:modern_kinetic_gun", "nbt": { "GunId": "immersive_armorer:standard_rail_pistol_mk1" } }, "count": 1 },
  ...
  }).id('qkl:attachment/bayonet_cb11');
  ...
  }).id('qkl:attachment/bayonet_fkc1');
  ...
  }).id('qkl:attachment/m1917_bayonet');
  ...
  }).id('qkl:attachment/m1905_bayonet');
  ...
  }).id('qkl:attachment/hy88_bayonet');
  ...
  }).id('qkl:attachment/m1925_bayonet');
