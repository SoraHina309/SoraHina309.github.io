ServerEvents.recipes(e => {
  ...
  materials.forEach(material => {
    ...
    e.shaped(`fallout:${material}_ingot`, [
      'NNN',
      'NNN',
      'NNN'
    ], { N: `fallout:${material}_nugget` });
  ...
  e.shaped('fallout:champion_suppression', [
    ...
    A: 'alexsmobs:spiked_scute', B: 'cataclysm:monstrous_eye', C: 'cataclysm:amethyst_crab_shell',
  ...
  // 精美小丑面具（第三阶段）
  e.shaped('fallout:jokey_3', [
    'A A',
    'BCB',
    ' D '
  ], {
    A: 'fallout:red_steel_ingot',
    B: 'fallout:blue_steel_ingot',
    C: 'fallout:jokey_2',
    D: 'cataclysm:black_steel_ingot'
  })

  // 皇家小丑面具（第四阶段）
  e.shaped('fallout:jokey_4', [
    'A A',
    'CDC',
    ' B'
  ], {
    A: 'fallout:orichalcum_ingot',
    B: 'fallout:mithril_ingot',
    C: 'minecraft:netherite_ingot',
    D: 'fallout:jokey_3'
  })

  // 彩虹小丑锤（终极锻造）
  e.shaped('fallout:reinbow_joker_hammer', [
    'ABC',
    'DED',
    ' F '
  ], {
    A: 'fallout:orichalcum_ingot',
    B: 'fallout:red_steel_ingot',
    C: 'fallout:blue_steel_ingot',
    D: 'mekanism:ingot_refined_obsidian',
    E: 'fallout:joker_hammer',
    F: 'minecraft:stick'
  })
  //放大镜
  ...
  e.shaped('fallout:petri_dish', [
    ...
    G: 'immersiveengineering:glass_insulating'
  }).stage('engineer');
