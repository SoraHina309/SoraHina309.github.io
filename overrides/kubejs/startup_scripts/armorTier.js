ItemEvents.armorTierRegistry(event => {
    ...
    event.add('fallout:jokey_1', tier => {
        tier.durabilityMultiplier = 40 // Each slot will be multiply_baseied with [13, 15, 16, 11]
    ...
    event.add('fallout:jokey_2', tier => {
        tier.durabilityMultiplier = 40 // Each slot will be multiply_baseied with [13, 15, 16, 11]
        tier.slotProtections = [2, 4, 5, 4] // Slot indicies are [FEET, LEGS, BODY, HEAD]
        tier.enchantmentValue = 6
        tier.toughness = 1.0
        tier.equipSound = 'minecraft:item.armor.equip_iron'
        tier.repairIngredient = '#forge:ingots/copper'
    ...
    event.add('fallout:jokey_3', tier => {
        tier.durabilityMultiplier = 40 // Each slot will be multiply_baseied with [13, 15, 16, 11]
        tier.slotProtections = [2, 4, 5, 6] // Slot indicies are [FEET, LEGS, BODY, HEAD]
        tier.enchantmentValue = 6
        tier.toughness = 3.0
        tier.equipSound = 'minecraft:item.armor.equip_iron'
        tier.repairIngredient = '#forge:ingots/copper'
    ...
    event.add('fallout:jokey_4', tier => {
        tier.durabilityMultiplier = 40 // Each slot will be multiply_baseied with [13, 15, 16, 11]
        tier.slotProtections = [2, 4, 5, 8] // Slot indicies are [FEET, LEGS, BODY, HEAD]
        tier.enchantmentValue = 6
        tier.toughness = 4.0
        tier.equipSound = 'minecraft:item.armor.equip_iron'
        tier.repairIngredient = '#forge:ingots/copper'
